        ...
        <div class="container"><!--waet zdet haydi ldiv loho baad shwey aan tarab abl mahatta ken mlaza2 aal taraf-->
            ...
            <div class="pin">
                <div class="position-relative">
                  ...
                  <a href="signup.php" class="text-decoration-none text-light mx-2"><!-- l'icône de l'utilisateur (user).-->
...
<div class="row content">
    ...
    <div class="center-text">
        ...
        <form action="register.php" method="post">
            ...
            <div class="field">
                <input class="btn" type="submit" value="Signup" name="reg_user">
            </div>
        </form>
        <p class="center-text"> Already have an account?</p>
            <a class="btn" href="signin.php">Signin</a> 
     </div>
</div>
